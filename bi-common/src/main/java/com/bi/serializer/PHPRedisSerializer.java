 ...
 * @author xianggu
 */
public class PHPRedisSerializer implements RedisSerializer<Object> {
    ...
    public Object deserialize(byte[] bytes) throws SerializationException {
        try {
            ...
            return deserialize(bytes, null, "UTF-8");
    ...
    public byte[] serialize(Object obj, String charset) {
    ...
    public int serialize(ByteArrayOutputStream stream, Object obj, HashMap ht, int hv, String charset) {
        if (obj == null) {
            hv++;
            writeNull(stream);
        } else {
    ...
    private int writeArray(ByteArrayOutputStream stream, Object a, HashMap ht, int hv, String charset) {
    ...
    private int writeArrayList(ByteArrayOutputStream stream, ArrayList a, HashMap ht, int hv, String charset) {
        int len = a.size();
        byte[] alen = getBytes(new Integer(len));
    ...
    private int writeHashMap(ByteArrayOutputStream stream, HashMap h, HashMap ht, int hv, String charset) {
        int len = h.size();
    ...
    private int writeObject(ByteArrayOutputStream stream, Object obj, HashMap ht, int hv, String charset) {
    ...
    public Object deserialize(byte[] ss, String charset) throws IllegalAccessException {
        return deserialize(ss, null, charset);
    }

    public Object deserialize(byte[] ss, Class cls) throws IllegalAccessException {
        return deserialize(ss, cls, "UTF-8");
    }

    public Object deserialize(byte[] ss, Class cls, String charset) throws IllegalAccessException {
        int hv = 1;
        ByteArrayInputStream stream = new ByteArrayInputStream(ss);
        //System.out.println("stream:"+stream);
        Object result = deserialize(stream, new HashMap(), hv, new HashMap(), charset).value;
    ...
    private UnSerializeResult deserialize(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset)
    ...
    private String readString(ByteArrayInputStream stream, String charset) {
        stream.skip(1);
    ...
    private UnSerializeResult readPointRef(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt) {
        stream.skip(1);
        Integer r = new Integer(readNumber(stream));
    ...
    private UnSerializeResult readArray(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset) throws IllegalAccessException {
        stream.skip(1);
        ...
        for (int i = 0; i < n; i++) {
            ...
            UnSerializeResult result = deserialize(stream, ht, hv, rt, charset);
        ...
        if (al != null) {
            ...
            if (((Boolean) (rt.get(r))).booleanValue()) {
                ...
                for (int i = 0; i < n; i++) {
                    ...
                    UnSerializeResult result = deserialize(stream, ht, hv, rt,
                            charset);
    ...
    private UnSerializeResult readObject(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset) throws IllegalAccessException {
        stream.skip(1);
        int len = Integer.parseInt(readNumber(stream));
    ...
    private UnSerializeResult readCustomObject(ByteArrayInputStream stream, HashMap ht, int hv, String charset) {
        stream.skip(1);
        int len = Integer.parseInt(readNumber(stream));
